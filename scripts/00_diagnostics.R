...
##
## Produces docs/diagnostics.html from data in data/processed/.
## Displays ALL sites present in the processed data.
## Covers QC-related diagnostics only: data completeness, QC timeline,
## QC threshold sensitivity, unit conversion check, and exclusion log summary.
## The site map (Section 1) uses plotly (interactive).
## QC / sensitivity sections use ggplot2 rendered to inline PNG (static).
##
## Non-QC figures (time series, climatology) live in 00_candidate_figures.R.
##
...
<title>FLUXNET Annual 2026 — QC Diagnostic Report</title>
...
<body>
<header>
  <h1>FLUXNET Annual 2026 — QC Diagnostic Report</h1>
  <p>QC diagnostics generated by 00_diagnostics.R &mdash;
     site map: plotly &bull; QC/sensitivity charts: ggplot2/PNG &bull;
     paper-candidate figures: see outputs/candidate_figures.html</p>
</header>
<main>
'
...
# ============================================================
# Section 4 — Unit conversion check
# ============================================================
build_s4 <- function() {
...
# ============================================================
# Section 5 — Exclusion log summary
# ============================================================
build_s5 <- function() {
...
message("Building Section 4 — Unit conversion check ...")
s4 <- section(4, "Unit conversion check",    build_s4())
message("Building Section 5 — Exclusion log summary ...")
s5 <- section(5, "Exclusion log summary",    build_s5())
